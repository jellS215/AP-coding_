...
teams_stats =nfl.import_seasonal_data([2020, 2021, 2022, 2023, 2024])
data = nfl.import_weekly_data([2020, 2021, 2022, 2023, 2024])
print(teams)
print(teams_stats)


win_totals = nfl.import_win_totals([2020, 2021, 2022, 2023, 2024])
